      ...
      >
        <div className="AdPerformanceDiv">
          ...
          <table className="AdPerformanceTable">
            ...
            <tr>
              <th>Step 02. 기준 지표</th>
              <Radio.Group defaultValue="노출수" onChange={handleChange}>
            ...
            <tr>
              <th>Step 03. 비교 지표</th>
              <td>
                <Radio.Group defaultValue="expose">
                  <Radio.Button value="expose">총 노출수</Radio.Button>
                  <Radio.Button value="click">총 클릭수</Radio.Button>
                  <Radio.Button value="ctr">CTR</Radio.Button>
                </Radio.Group>
              </td>
            </tr>
